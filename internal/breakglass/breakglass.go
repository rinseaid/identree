...
func RotateBreakglass(cfg *config.ClientConfig, force, quiet bool) (plaintext string, err error) {
...
func ComputeEscrowToken(sharedSecret, hostname, timestamp string) string {
	mac := hmac.New(sha256.New, config.DeriveKey(sharedSecret, "escrow"))
...
func MaybeRotateBreakglass(cfg *config.ClientConfig, rotateBefore time.Time) {
